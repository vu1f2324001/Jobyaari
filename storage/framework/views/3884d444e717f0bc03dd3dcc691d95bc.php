    ...
    <div class="col-lg-7">
        <div class="p-4 p-lg-5 hero-card">
            ...
            <div class="d-flex gap-2 flex-wrap">
                <a href="<?php echo e(url('/blogs')); ?>" class="btn btn-primary btn-lg">
                    <i class="fa-solid fa-book-open me-2"></i>Browse Blogs
                </a>
                <a href="<?php echo e(url('/blogs')); ?>#categories" class="btn btn-outline-light btn-lg">
...
<div class="d-flex align-items-center justify-content-between mb-3">
    ...
    <a href="<?php echo e(url('/blogs')); ?>" class="text-decoration-none">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\varsha\Desktop\god\jobyaari\resources\views/home.blade.php ENDPATH**/ ?>