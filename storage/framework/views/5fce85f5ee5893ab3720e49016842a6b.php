            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h4 class="fw-bold mb-0" id="editor-title">
                        ...
                        <?php echo e(isset($id) ? 'Edit Blog' : 'New Blog'); ?>

                    </h4>
                    <div class="d-flex gap-2">
                        <a class="btn btn-outline-secondary btn-sm" href="<?php echo e(url('/admin/blogs')); ?>">
                ...
                <form id="blog-editor-form" enctype="multipart/form-data">
                    <input type="hidden" id="blog-id" value="<?php echo e(isset($id) ? $id : ''); ?>">
                    ...
                    <div class="d-flex gap-2">
                        <button id="btn-save-blog" class="btn btn-primary" type="submit">
                            ...
                            <?php echo e(isset($id) ? 'Update Blog' : 'Create Blog'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\varsha\Desktop\god\jobyaari\resources\views/admin/blogs_edit.blade.php ENDPATH**/ ?>